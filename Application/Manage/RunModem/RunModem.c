 ...
 */
#define MODULE_RUNMODEM_ID               25 
#define MODULE_RUNMODEM_NAME             "RUNMODEM"    //  platform name include "EV02" "EV03" "EV04" "EV05"                                      
#define RUNMODEM_SW_MAJOR_VERSION         1     //  size is uByte,max number is 255                                            
#define RUNMODEM_SW_MINOR_VERSION         1    //  size is uWord,max number is 65535                                           
#define RUNMODEM_SW_REVISION_VERSION      0   //  size is uWord,max number is 65535                                               
#define RUNMODEM_DEVELOP_STATUS           "" /* status include "beta" "rc" ""                                 
                                               *  "beta" ---- beta
                                               *  "rc"   ---- Release Candidate
                                               *  ""  or the blank or '\0' represent Release,display blank in monitor
                                               */
/* Version Get Interface */
const sVersion_CodeType RunModem_VerDef =
{
  MODULE_RUNMODEM_NAME,
  RUNMODEM_SW_MAJOR_VERSION,
  RUNMODEM_SW_MINOR_VERSION,
  RUNMODEM_SW_REVISION_VERSION,
  0,
  0,
  RUNMODEM_DEVELOP_STATUS
};                                               
ModuleID_Type RunModem_GetVesionModuleVer(sVersion_CodeType * VerPtr)
{
  if(VerPtr == NULL)
  {
    return  NULL_MODULE_ID; 
  }
  *VerPtr = RunModem_VerDef;
  return MODULE_RUNMODEM_ID;   
}
