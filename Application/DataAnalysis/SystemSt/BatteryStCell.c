...
uWord Bat_GetCellBalanceTimeRemain(uWord local_cell_no)
{
    __ASSERT(local_cell_no > 0);
    ...
    return  Bat_LocalPackBalTime.BalTimeRemain[local_cell_no];


}

eBat_ReturnType Bat_UpdateCellBalanceTimeRemain(uWord local_cell_no, uWord bal_time_remain)
{
    __ASSERT(local_cell_no > 0);
    ...
    Bat_LocalPackBalTime.BalTimeRemain[local_cell_no] = bal_time_remain;
...
uByte Bat_GetCellBalanceSt(uByte bmu_no, uWord local_cell_no)
{
    ...
    return (Bat_AllInfo.PackInfoPtrRef[0]->CellStPtr[local_cell_no].Cell_Info.Info & 0x3c);
#endif
...
#if ((ECU_CATEGORY == M_BMU) || (ECU_CATEGORY == M_BMU_R))
    btmp = Bat_AllInfo.PackInfoPtrRef[0]->CellStPtr[local_cell_no].Cell_Info.Info & 0xc3;
    btmp |= bal_st;
    Bat_AllInfo.PackInfoPtrRef[0]->CellStPtr[local_cell_no].Cell_Info.Info = btmp;
#endif
...
#if ((ECU_CATEGORY == M_BMU) || (ECU_CATEGORY == M_BMU_R))
    return Bat_AllInfo.PackInfoPtrRef[0]->CellBasicPtr[local_cell_no].Voltage;
#endif
...
#if ((ECU_CATEGORY == M_BMU) || (ECU_CATEGORY == M_BMU_R))
    Bat_AllInfo.PackInfoPtrRef[0]->CellBasicPtr[local_cell_no].Voltage = voltage;
#endif
...
#if ((ECU_CATEGORY == M_BMU) || (ECU_CATEGORY == M_BMU_R))
    return Bat_AllInfo.PackInfoPtrRef[0]->CellBasicPtr[local_cell_no].Int_Res;
#endif
...
#if ((ECU_CATEGORY == M_BMU) || (ECU_CATEGORY == M_BMU_R))
    Bat_AllInfo.PackInfoPtrRef[0]->CellBasicPtr[local_cell_no].Int_Res = intres;
#endif
