...
static void Bat_CalcPackMaxMin(void);
#endif
...
void Bat_DataProcessInit(void)
{
    ...
    (void)SysConf_InitParaTable(SYSTEMST_HSTY_SOC_AREA_INFO_G2, ((uLWord)(&(Bat_AllInfo.HisInfoPtr->SocDis[7])) ), 28);
   ...
   // Prj_WrCapacity();
    ...
    (void)SysConf_InitParaTable(SYSTEMST_TOTAL_CHG_BAL_TIME_41_60, ((uLWord)(&(Bat_LocalPackBalTime.ChgBalTimeTotal[30]))), 12);
    ...
    (void)SysConf_InitParaTable(SYSTEMST_TOTAL_DCH_BAL_TIME_41_60, ((uLWord)(&(Bat_LocalPackBalTime.DchBalTimeTotal[30]))), 12);
    ...
    (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_1_15, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[0]))), 30);
    (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_16_30, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[15]))), 30);
    (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_31_45, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[30]))), 30);
    (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_46_60, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[45]))), 6);
    
    #if(MAX_CELL_NUM > 60)
    {
       (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_61_75, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[60]))), 30);
        (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_76_90, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[75]))), 30);
        (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_91_105, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[90]))), 30);
        (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_106_120, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[105]))), 30);

    }
    #endif
    #if(MAX_CELL_NUM > 120)
    {
        (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_121_135, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[120]))), 30);
        (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_136_150, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[135]))), 30);
        (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_151_165, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[150]))), 30);
        (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_166_180, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[165]))), 30);
    }
    #endif
    #if(MAX_CELL_NUM > 180)
    {
        (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_181_195, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[180]))), 30);
        (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_196_210, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[195]))), 30);
        (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_211_225, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[210]))), 30);
        (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_226_240, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[225]))), 30);
    }
    #endif
    #if(MAX_CELL_NUM > 240)
    {
        (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_241_255, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[240]))), 30);
        (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_256_270, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[255]))), 30);
        (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_271_285, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[270]))), 30);
        (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_286_300, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[285]))), 30);
    }
    #endif
#endif
    ...
    (void)SysConf_InitParaTable(SYSTEMST_BAT_PACK_INFO_G1, ((uLWord)(&(Bat_AllInfo.PackInfoPtrRef[0]->PackParameter.PackParameter1)) ), sizeof(Bat_AllInfo.PackInfoPtrRef[0]->PackParameter.PackParameter1));
    (void)SysConf_InitParaTable(SYSTEMST_BAT_PACK_INFO_G2, ((uLWord)(&(Bat_AllInfo.PackInfoPtrRef[0]->PackParameter.PackParameter2)) ), sizeof(Bat_AllInfo.PackInfoPtrRef[0]->PackParameter.PackParameter2));
    (void)SysConf_InitParaTable(SYSTEMST_BAT_PACK_INFO_G3, ((uLWord)(&(Bat_AllInfo.PackInfoPtrRef[0]->PackParameter.PackParameter3)) ), sizeof(Bat_AllInfo.PackInfoPtrRef[0]->PackParameter.PackParameter3));
    (void)SysConf_InitParaTable(SYSTEMST_BAT_PACK_INFO_G4, ((uLWord)(&(Bat_AllInfo.PackInfoPtrRef[0]->PackParameter.PackParameter4)) ), sizeof(Bat_AllInfo.PackInfoPtrRef[0]->PackParameter.PackParameter4));

    (void)SysConf_InitParaTable(SYSTEMST_REMAIN_CAPACITY_BAK_G1, ((uLWord)(&(Bat_AllInfo.PackInfoPtrRef[0]->PackOtherInfo.RemainCapacity)) ), sizeof(Bat_AllInfo.PackInfoPtrRef[0]->PackOtherInfo.RemainCapacity));
    (void)SysConf_InitParaTable(SYSTEMST_REMAIN_CAPACITY_BAK_G2, ((uLWord)(&(Bat_AllInfo.PackInfoPtrRef[0]->PackOtherInfo.RemainCapacity)) ), sizeof(Bat_AllInfo.PackInfoPtrRef[0]->PackOtherInfo.RemainCapacity));
    (void)SysConf_InitParaTable(SYSTEMST_REMAIN_CAPACITY_BAK_G3, ((uLWord)(&(Bat_AllInfo.PackInfoPtrRef[0]->PackOtherInfo.RemainCapacity)) ), sizeof(Bat_AllInfo.PackInfoPtrRef[0]->PackOtherInfo.RemainCapacity));
    (void)SysConf_InitParaTable(SYSTEMST_REMAIN_CAPACITY_BAK_G4, ((uLWord)(&(Bat_AllInfo.PackInfoPtrRef[0]->PackOtherInfo.RemainCapacity)) ), sizeof(Bat_AllInfo.PackInfoPtrRef[0]->PackOtherInfo.RemainCapacity));
    (void)SysConf_InitParaTable(SYSTEMST_REMAIN_CAPACITY_BAK_G5, ((uLWord)(&(Bat_AllInfo.PackInfoPtrRef[0]->PackOtherInfo.RemainCapacity)) ), sizeof(Bat_AllInfo.PackInfoPtrRef[0]->PackOtherInfo.RemainCapacity));
    (void)SysConf_InitParaTable(SYSTEMST_REMAIN_CAPACITY_BAK_G6, ((uLWord)(&(Bat_AllInfo.PackInfoPtrRef[0]->PackOtherInfo.RemainCapacity)) ), sizeof(Bat_AllInfo.PackInfoPtrRef[0]->PackOtherInfo.RemainCapacity));

    (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_1_15, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[0]))), 30);
    (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_16_30, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[15]))), 30);
    (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_31_45, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[30]))), 30);  
    (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_46_60, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[45]))), 30);
    (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_BAK_1_15, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[0]))), 30);
    (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_BAK_16_30, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[15]))), 30);
    (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_BAK_31_45, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[30]))), 30); 
    (void)SysConf_InitParaTable(SYSTEMST_BAL_TIME_BAK_46_60, ((uLWord)(&(Bat_LocalPackBalTime.BalTimeRemain[45]))), 30);
  
    WdgIf_Trig();
    /* load pack info from EE */
    rslt = 0;
    rslt = EE_LoadVar(SYSTEMST_BAT_PACK_INFO_G1);
    rslt |= EE_LoadVar(SYSTEMST_BAT_PACK_INFO_G2);
   /* if(ERR_OK != rslt) 
    ...
    /*Close,  the monitor have no write pack information */
    
    
    rslt = EE_LoadVar(SYSTEMST_BAT_PACK_INFO_G3);
    rslt = EE_LoadVar(SYSTEMST_BAT_PACK_INFO_G4);
    WdgIf_Trig();
    /* load remain capacity from EE */
    rslt = EE_LoadVar(SYSTEMST_REMAIN_CAPACITY_BAK_G1);
...
static void Bat_TemperRiseCalc(void)          /*from power on */
{
    ...
    if((BAT_FLAG_FAIL == Bat_StCalc.MaxTBakFlg) && (0 != Bat_GetMaxT()))
    { 
...
static void Bat_TemperRisePerHourCalc(void)
{
    ...
    if((BAT_FLAG_FAIL == Bat_StCalc.PerHourFlg) && (0 != Bat_GetMaxT()))
    {
...
static void Bat_TemperMaxTRiseRateCalc(void)
{
    ...
    else
    {
        ...
        temp_rise_rate = (temp_rise_rate * 10) / (BAT_CNT_TEMPER_RISE_RATE / 60); 
...
/* calc pack max and min infor */
#if ((ECU_CATEGORY == M_BMU) || (ECU_CATEGORY == M_BMU_R) || (ECU_CATEGORY == M_BCU_C))
void Bat_CalcPackMaxMin(void)
{
    uByte bmu_no;
    uByte dlen;
    uByte data[4];
    uWord local_cell_no, local_temper_no;
    uWord serial_num, temper_num;
    uWord actual_serial_num, actual_temper_num;
    uByte temper, avg_t, delta_t;
    uWord cell_v, avg_v, delta_v;
    uWord pack_max_v_no, pack_min_v_no;
    uWord pack_max_t_no, pack_min_t_no;
    uWord pack_max_v, pack_min_v;
    uByte pack_max_t, pack_min_t;
    uLWord pack_acc_v, pack_acc_t;
...
/* prepare parameter to calc max min */
#if ((ECU_CATEGORY == M_BMU) || (ECU_CATEGORY == M_BMU_R))
    (void)SysConf_GetParaValueFromRam(SYSCONF_BMU_NO, &bmu_no, &dlen);
    (void)SysConf_GetParaValueFromRam(SYSCONF_BMU_VOLT_PARA, &data[0], &dlen);  
    serial_num = data[1] + (data[0] << 8);
    
    (void)SysConf_GetParaValueFromRam(SYSCONF_BMU_TEMPER_PARA, &data[0], &dlen);  
    temper_num = data[1] + (data[0] << 8);
#else  /* M_BCU_C */
    bmu_no = 0;
    (void)SysConf_GetParaValueFromRam(SYSCONF_BMU0_CELLNUM, (uByte*)&serial_num, &dlen);
    (void)SysConf_GetParaValueFromRam(SYSCONF_BMU0_TEMPERNUM, (uByte *)&temper_num, &dlen);
#endif /* #if ((ECU_CATEGORY == M_BMU) || (ECU_CATEGORY == M_BMU_R)) */
/* end of prepare parameter to calc max min */
   actual_serial_num = serial_num;
   actual_temper_num = temper_num;


#ifdef __DEBUG_BATST_TEST_BMU     
    serial_num = 60;
    temper_num = 8;
    Bat_UpdateSlaveNo(1);
    bmu_no = Bat_GetSlaveNo();

    for(i = 1; i < serial_num + 1; i++)
    {
        Bat_UpdateCellV(bmu_no, i, 3000 + i * 10);
    }

    for(i = 1; i < temper_num + 1; i++)
    {
        Bat_UpdateTemper(bmu_no, i, 40 + i);
    }
#endif   /* #ifdef __DEBUG_BATST_TEST_BMU */
   

    /* begin to calc max and min */
    pack_acc_v = 0;
    for(local_cell_no = 1; (local_cell_no < (serial_num + 1)); local_cell_no++)
    {
        cell_v = Bat_GetCellV(bmu_no, local_cell_no);
      
       if(0xFFFF != cell_v)
       {
            pack_acc_v += cell_v;
            if(cell_v > pack_max_v)
            {
                pack_max_v = cell_v;
                pack_max_v_no = local_cell_no;
            }

            if(cell_v < pack_min_v)
            {
                pack_min_v = cell_v;
                pack_min_v_no = local_cell_no;
            }
      }
      else
      {
    ...
    pack_acc_t = 0;
    for(local_temper_no = 1; local_temper_no < (temper_num + 1); local_temper_no++)
    {
        temper = Bat_GetTemper(bmu_no, local_temper_no);
        if(0xFF != temper)
        {
            pack_acc_t += temper;
            if(temper > pack_max_t)
            {
                pack_max_t = temper;
                pack_max_t_no = local_temper_no;
            }

            if(temper < pack_min_t)
            {
                pack_min_t = temper;
                pack_min_t_no = local_temper_no;
            }
        }
        else
        {
    ...
    avg_v = (uWord)(pack_acc_v / actual_serial_num);
    avg_t = (uByte)(pack_acc_t / actual_temper_num);

    if((pack_min_t == 0) || (pack_min_t == 0xFF))
    {
        pack_min_t = 40;
    }
    if((pack_max_t == 0) || (pack_max_t == 0xFF))
    {
        pack_max_t = 40;
    }
    if((avg_t == 0) || (avg_t == 0xFF))
    {
        avg_t = 40;
    }

    (pack_max_t > pack_min_t) ? (delta_t = pack_max_t - pack_min_t) : (delta_t = 0);
    (pack_max_v > pack_min_v) ? (delta_v = pack_max_v - pack_min_v) : (delta_v = 0);

    (void)Bat_UpdatePackDeltaT(bmu_no, delta_t);
    (void)Bat_UpdatePackDeltaV(bmu_no, delta_v);

    (void)Bat_UpdatePackAvgT(bmu_no, avg_t);
    (void)Bat_UpdatePackAvgV(bmu_no, avg_v);

    (void)Bat_UpdatePackMaxV(bmu_no, pack_max_v);
    (void)Bat_UpdatePackMaxT(bmu_no, pack_max_t);
    (void)Bat_UpdatePackMinV(bmu_no, pack_min_v);
    (void)Bat_UpdatePackMinT(bmu_no, pack_min_t);

    (void)Bat_UpdatePackMaxVNo(bmu_no, pack_max_v_no);
    (void)Bat_UpdatePackMinVNo(bmu_no, pack_min_v_no);
    (void)Bat_UpdatePackMaxTNo(bmu_no, pack_max_t_no);
    (void)Bat_UpdatePackMinTNo(bmu_no, pack_min_t_no);

    (void)Bat_UpdatePackSumV(bmu_no, ACC_SUMV, (uWord)(pack_acc_v / 100));
    (void)Bat_UpdatePackTemperNum(bmu_no, (uByte)temper_num);
    (void)Bat_UpdatePackBatNum(bmu_no, (uByte)serial_num);
}
#endif
/* end of calc pack max and min infor */
...
void Bat_CalcAllMaxMin(void)
{
    ...
    for(bmu_no = start_bmu_no; bmu_no < total_bmu_num; bmu_no++)
    {
        ...
        if((0xFFFF != Bat_GetPackMaxV(bmu_no)) && (0xFFFF != Bat_GetPackMinV(bmu_no)))
        {
        ...
        if((0xFF != Bat_GetPackMaxT(bmu_no)) && (0xFF != Bat_GetPackMinT(bmu_no)))
        {
      ...
      //  total_v += Bat_GetPackSumV(bmu_no, ACC_SUMV); 
        ...
        for(local_cell_no = 1; local_cell_no < (Bat_GetPackBatNum(bmu_no) + 1); local_cell_no++)
        {
            if(0xFFFF == Bat_GetCellV(bmu_no, local_cell_no))
            {
               total_serial_num -= 1;
            }
            else
        ...
        {
            if(0xFF != Bat_GetTemper(bmu_no, local_temper_no))
            {
    ...
    if((min_t == 0) || (min_t == 0xFF))
    {
       min_t = 40;
    }
    if((max_t == 0) || (max_t == 0xFF))
    {
       max_t = 40;
    }
    if((avg_t == 0) || (avg_t == 0xFF))
    ...
    Bat_UpdateSumV(ACC_SUMV, (uWord)total_v);
