...
uByte BatSys_GetAllPackPosRlySt(uByte bmu_no)
{
    return  BatSys_StInfo.PackRelaySt[bmu_no].PosRlySt;
}

void BatSys_UpdateAllPackPosRlySt(uByte bmu_no, uByte status)
{
    BatSys_StInfo.PackRelaySt[bmu_no].PosRlySt = status;
}

uByte BatSys_GetAllPackNegRlySt(uByte bmu_no)
{
    return  BatSys_StInfo.PackRelaySt[bmu_no].NegRlySt;
}

void BatSys_UpdateAllPackNegRlySt(uByte bmu_no, uByte status)
{
    BatSys_StInfo.PackRelaySt[bmu_no].NegRlySt = status;
}

uByte BatSys_GetAllPackPreRlySt(uByte bmu_no)
{
    return  BatSys_StInfo.PackRelaySt[bmu_no].PreRlySt;
}

void BatSys_UpdateAllPackPreRlySt(uByte bmu_no, uByte status)
{
    BatSys_StInfo.PackRelaySt[bmu_no].PreRlySt = status;
}

uByte BatSys_GetAllPackChgRlySt(uByte bmu_no)
{
    return  BatSys_StInfo.PackRelaySt[bmu_no].ChgRlySt;
}

void BatSys_UpdateAllPackChgRlySt(uByte bmu_no, uByte status)
{
    BatSys_StInfo.PackRelaySt[bmu_no].ChgRlySt = status;
}

uByte BatSys_GetAllPackAuxBSt(uByte bmu_no)
{
    return  BatSys_StInfo.PackRelaySt[bmu_no].AuxBSt;
}

void BatSys_UpdateAllPackAuxBSt(uByte bmu_no, uByte status)
{
    BatSys_StInfo.PackRelaySt[bmu_no].AuxBSt = status;
}

uByte BatSys_GetAllPackAuxASt(uByte bmu_no)
{
    return  BatSys_StInfo.PackRelaySt[bmu_no].AuxASt;
}

void BatSys_UpdateAllPackAuxASt(uByte bmu_no, uByte status)
{
    BatSys_StInfo.PackRelaySt[bmu_no].AuxASt = status;
}
#endif // endif MAX_BMU_NUM
#endif
