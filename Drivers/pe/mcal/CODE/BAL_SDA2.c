...
#pragma DATA_SEG BAL_SDA2_DATA         /* Select data segment "BAL_SDA2_DATA" */
#pragma CODE_SEG BAL_SDA2_CODE
#pragma CONST_SEG BAL_SDA2_CONST       /* Constant section for this module */
/*
** ===================================================================
...
*/
/*
bool BAL_SDA2_GetVal(void)

**  This method is implemented as a macro. See BAL_SDA2.h file.  **
*/
...
{
  setReg8(PORTC, (getReg8(PORTC) & (byte)(~(byte)0x02U)) | (Shadow_C & 0x02U)); /* PC1=Shadow_C[bit 1] */
  setReg8Bits(DDRC, 0x02U);            /* DDRC1=0x01U */
}
