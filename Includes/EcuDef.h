 ...
 */
#define ACTUAL_PROJECT_NAME "BLN01AMS6829" /*  project name = PROJECT CODE  + Old version number 
...
#define ACTUAL_PROJECT_DEVELOP_STATUS          "" /* status include "beta" "rc" ""                                 
                                              *  "beta" ---- beta
