 ...
 */
#define MODULE_SYSTEMST_ID               114 
#define MODULE_SYSTEMST_NAME             "SYSTEMST-A"   //  platform name include "EV02" "EV03" "EV04" "EV05"                                      
#define SYSTEMST_SW_MAJOR_VERSION        1      //  size is uByte,max number is 255                                            
#define SYSTEMST_SW_MINOR_VERSION        1      //  size is uWord,max number is 65535                                           
#define SYSTEMST_SW_REVISION_VERSION     0      //  size is uWord,max number is 65535                                               
#define SYSTEMST_DEVELOP_STATUS          "0" /* status include "beta" "rc" ""                                 
                                               *  "beta" ---- beta
...
#define BAT_CNT_SOC_DIS       600        /* 10 min */
#define BAT_CNT_MIN_TEMP_DIS  600        /* 10 min */
#define BAT_CNT_MAX_TEMP_DIS  600        /* 10 min */
#define BAT_CNT_AVG_TEMP_DIS  600        /* 10 min */
#define BAT_CNT_DELTA_TEMP_DIS 600       /* 10 min */
#define BAT_CNT_TEMPER_RISE   60         /* 1 min */
#define BAT_CNT_1HOUR         3600       /* 1 Hour */
#define BAT_CNT_TEMPER_RISE_RATE 600     /* 10 min */
#define BAT_CNT_CUR_DIS       600        /* 10 min */
#define BAT_CNT_POW_ON        300        /* 5 min  */
#define BAT_CNT_CHG_TIMES     300        /* 5 min  */
#define BAT_CNT_CLEAR         0        


#define BAT_CHG_START_CNT          6000   /* 5min */
...
typedef struct
{
    ...
    uWord BalTimeRemain[MAX_PACK_CELL_NUM];
#endif

#if ((ECU_CATEGORY == M_BCU_C) || (ECU_CATEGORY == M_BCU_D))

#if(ECU_CATEGORY == M_BCU_C)
    uWord BalTimeRemain[MAX_CELL_NUM];
#endif
...
extern  uWord Bat_GetCellBalanceTimeRemain(uWord local_cell_no);
extern eBat_ReturnType Bat_UpdateCellBalanceTimeRemain(uWord local_cell_no, uWord bal_time_remain);
#endif
...
extern ModuleID_Type SystemSt_GetVesionModuleVer(sVersion_CodeType * VerPtr);
