...
#define SUMV_OUT_RANGE_THRED      0x7FFF                                                                                  
...
//#define SUMV_CONTINUE_CONV_AIN1_128SPS    0xD983//0x5983//0x5883 //FS:0.512V, for inner sumv and ext sumv
//#define SUMVBAK_CONTINUE_CONV_AIN2_128SPS  0xE983//0x6983//0x6883 //FS:0.512V, for inner sumv backup

#define SUMV_SIG_CONV_AIN1_128SPS    0xD783// FS:1.024//0xD983 //FS:0.512V, for inner sumv and ext sumv
#define SUMVBAK_SIG_CONV_AIN2_128SPS 0xE783//FS:1.024//0xE983 //FS:0.512V, for inner sumv backup
                                  //D583 2.048
#endif  
#endif /* SUMVIF_TYPE_H */ 