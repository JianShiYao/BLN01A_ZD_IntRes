...
#define MODULE_ERRORALARM_ID           113
#define MODULE_ERRORALARM_NAME         "ERRORALARM-A"
#define ERRORALARM_SW_MAJOR_VERSION    1      // size is uByte, max number is 255
#define ERRORALARM_SW_MINOR_VERSION    1      // size is uWord, max number is 65535
#define ERRORALARM_SW_REVISION_VERSION 0      // size is uWord, max number is 65535
#define ERRORALARM_DEVELOP_STATUS      "rc" // status include "beta" "rc" ""
...
extern ModuleID_Type ErrorAlarm_GetVesionModuleVer(sVersion_CodeType * VerPtr);
