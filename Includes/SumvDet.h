...
#define MODULE_SUMVDET_ID           30
#define MODULE_SUMVDET_NAME         "SUMVDET"
#define SUMVDET_SW_MAJOR_VERSION    1      // size is uByte,max number is 255
#define SUMVDET_SW_MINOR_VERSION    1      // size is uWord,max number is 65535
#define SUMVDET_SW_REVISION_VERSION 0      // size is uWord,max number is 65535
#define SUMVDET_DEVELOP_STATUS      "" // status include "beta" "rc" ""


#define SUMVDET_NUM   1      /* inner sumv, inner sumv backup, extern sumv */
...
extern ModuleID_Type SumvDet_GetVesionModuleVer(sVersion_CodeType * VerPtr);
