...
#define BCUDMCAL_MODULE_VERSION_NAME             "BCUDMACL"    //  platform name include "EV02" "EV03" "EV04" "EV05"                                      
#define BCUDMCAL_VERSION_SW_MAJOR_VERSION         1     //  size is uByte,max number is 255                                            
#define BCUDMCAL_VERSION_SW_MINOR_VERSION         0    //  size is uWord,max number is 65535                                           
#define BCUDMCAL_VERSION_SW_REVISION_VERSION      0   //  size is uWord,max number is 65535                                               
