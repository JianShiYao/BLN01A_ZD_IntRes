...
#if(MAX_BMU_NUM)
    sBatSys_RelayStType      PackRelaySt[MAX_BMU_NUM];
...
extern uByte BatSys_GetAllPackPosRlySt(uByte bmu_no);
extern void BatSys_UpdateAllPackPosRlySt(uByte bmu_no, uByte status);

extern uByte BatSys_GetAllPackNegRlySt(uByte bmu_no);
extern void BatSys_UpdateAllPackNegRlySt(uByte bmu_no, uByte status);
