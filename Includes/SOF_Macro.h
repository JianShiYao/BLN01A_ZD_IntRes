...
// select function
#define SOF_DCH_CUR_VOLT_MODIFY   SOF_FUN_ENABLE
#define SOF_DCH_CUR_ERR_MODIFY    SOF_FUN_ENABLE
...
// define for array
#define SOF_MAX_T_POINT      15
#define SOF_MAX_SOC_POINT    12
...
#define SOF_CONST_DCHCUR_SMOOTH_UNIT       10    // 1A/100ms, unit 0.1A
#define SOF_CONST_FEEDBACKCUR_SMOOTH_UNIT  10    // 1A/100ms, unit 0.1A
#define SOF_PULSE_DCHCUR_SMOOTH_UNIT       10    // 1A/100ms, unit 0.1A
#define SOF_PULSE_FEEDBACKCUR_SMOOTH_UNIT  10    // 1A/100ms, unit 0.1A

#define SOF_CONST_DCHPOW_SMOOTH_UNIT       10    // 1kw/100ms, unit 0.1kw
#define SOF_CONST_FEEDBACKPOW_SMOOTH_UNIT  10    // 1kw/100ms, unit 0.1kw
#define SOF_PULSE_DCHPOW_SMOOTH_UNIT       10    // 1kw/100ms, unit 0.1kw
#define SOF_PULSE_FEEDBACKPOW_SMOOTH_UNIT  10    // 1kw/100ms, unit 0.1kw
