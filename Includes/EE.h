...
#define MODULE_EE_NAME             "EE-E" //  platform name include "EV02" "EV03" "EV04" "EV05"                                      
#define EE_SW_MAJOR_VERSION        1      //  size is uByte,max number is 255                                            
#define EE_SW_MINOR_VERSION        0      //  size is uWord,max number is 65535                                           
#define EE_SW_REVISION_VERSION     0      //  size is uWord,max number is 65535                                               
#define EE_DEVELOP_STATUS          "beta" /* status include "beta" "rc" ""                                 
                                               *  "beta" ---- beta
