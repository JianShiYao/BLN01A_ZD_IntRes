 ...
 */
#define MODULE_DATASTORE_ID               111 
#define MODULE_DATASTORE_NAME             "DATASTORE-A"  //  platform name include "EV02" "EV03" "EV04" "EV05"                                      
#define DATASTORE_SW_MAJOR_VERSION        1      //  size is uByte,max number is 255                                            
#define DATASTORE_SW_MINOR_VERSION        1      //  size is uWord,max number is 65535                                           
#define DATASTORE_SW_REVISION_VERSION     1      //  size is uWord,max number is 65535                                               
#define DATASTORE_DEVELOP_STATUS          "" /* status include "beta" "rc" ""                                 
                                               *  "beta" ---- beta
...
extern ModuleID_Type DataStore_GetVesionModuleVer(sVersion_CodeType * VerPtr);
